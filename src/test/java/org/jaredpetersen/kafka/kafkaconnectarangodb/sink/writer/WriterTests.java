...
class WriterTests {
  @Test
  void writeSingleCollectionRepsertWritesRecords() {
    // Set up input stubs
  ...
  @Test
  void writeMultipleCollectionRepsertWritesRecords() {
    // Set up input stubs
    final List<ArangoRecord> arangoRecordStubs = Arrays.asList(
        new ArangoRecord("somecollection", "aKey", "ajson"),
        new ArangoRecord("somecollection", "bKey", "bjson"),
  ...
  @Test
  void writeSingleCollectionDeleteWritesRecords() {
    // Set up input stubs
    final List<ArangoRecord> arangoRecordStubs = Arrays.asList(
  ...
  @Test
  void writeMultipleCollectionDeleteWritesRecords() {
    // Set up input stubs
    final List<ArangoRecord> arangoRecordStubs = Arrays.asList(
        new ArangoRecord("somecollection", "aKey", null),
        new ArangoRecord("somecollection", "bKey", null),
