...
class RecordConverterTests {
  private Schema keyStructSchema = SchemaBuilder.struct()
      .name("key").version(1).doc("key schema")
      .field("Id", Schema.INT32_SCHEMA)
      .build();
  private Schema valueStructSchema = SchemaBuilder.struct()
  ...
  @Test
  void convertSchemafulRecordReturnsArangoRecord() {
    // Set up stub data
  ...
  @Test
  void convertSchemafulTombstoneRecordReturnsArangoRecord() {
    // Set up stub data
    final Struct keyStub = new Struct(this.keyStructSchema)
        .put("Id", 45);
  ...
  @Test
  void convertSchemafulNonSingleObjectRecordThrowsException() {
    // Set up stub data
    final Struct keyStub = new Struct(this.keyStructSchema)
        .put("Id", 45);
  ...
  @Test
  void convertSchemalessRecordReturnsArangoRecord() {
    // Set up stub data
  ...
  @Test
  void convertSchemalessTombstoneRecordReturnsArangoRecord() {
    // Set up stub data
    final Map<String, Object> keyStub = new LinkedHashMap<>();
    keyStub.put("Id", 45);
  ...
  @Test
  void convertSchemalessNonSingleObjectRecordThrowsException() {
    // Set up stub data
    final Map<String, Object> keyStub = new LinkedHashMap<>();
    keyStub.put("Id", 45);
